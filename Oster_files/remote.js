...
c);a.la("statustext",c);a.u.show()}else a.u.hide()},M8=function(){g.R.call(this,{D:"div",
H:"ytp-mdx-manual-pairing-popup-dialog",O:{role:"dialog"},J:[{D:"div",H:"ytp-mdx-manual-pairing-popup-dialog-inner-content",J:[{D:"div",H:"ytp-mdx-manual-pairing-popup-title",W:"Connecting to your TV on web using a code will be going away soon"},{D:"div",H:"ytp-mdx-manual-pairing-popup-buttons",J:[{D:"button",Y:["ytp-button","ytp-mdx-manual-pairing-popup-learn-more"],W:"\u041f\u043e\u0434\u0440\u043e\u0431\u043d\u0435\u0435..."},{D:"button",Y:["ytp-button","ytp-mdx-manual-pairing-popup-ok"],W:"\u041e\u041a"}]}]}]});
this.u=new g.lN(this,250);this.learnMoreButton=this.o["ytp-mdx-manual-pairing-popup-learn-more"];this.okButton=this.o["ytp-mdx-manual-pairing-popup-ok"];g.B(this,this.u);this.L(this.learnMoreButton,"click",this.w);this.L(this.okButton,"click",this.A)},N8=function(){g.R.call(this,{D:"div",
...
this.u={key:h6(),name:"\u042d\u0442\u043e\u0442 \u043a\u043e\u043c\u043f\u044c\u044e\u0442\u0435\u0440"};this.C=null;this.w=[];this.ba=this.o=null;this.U=[this.u];this.A=this.u;this.I=new g.HC(64);this.V=0;this.M=-1;this.F=null;this.P=this.R=!1;this.G=null;if(!g.az(this.player.N())){a=this.player;var b=g.dC(a);b&&(b=b.fm())&&(b=new O8(a,b),g.B(this,b));b=new L8(a);g.B(this,b);g.iL(a,b.element,4);this.G=new N8;g.B(this,this.G);g.iL(a,this.G.element,4);g.P(this.player.N().experiments,"pair_servlet_deprecation_warning_enabled")&&
(this.F=new M8,g.B(this,this.F),g.iL(a,this.F.element,4));this.P=!!t8();this.R=!!g.Es("yt-remote-manual-pairing-warning-shown")}this.B=null},Q8=function(a){a.B&&(a.player.removeEventListener("presentingplayerstatechange",a.B),a.B=null)},Cya=function(a,b,c){a.I=c;
...
break;case -1:H8(this,new g.HC(64));break;case -1E3:H8(this,new g.HC(128,{errorCode:"mdx.remoteerror",errorMessage:"\u0412\u0438\u0434\u0435\u043e \u043d\u0435\u0434\u043e\u0441\u0442\u0443\u043f\u043d\u043e \u0434\u043b\u044f \u0443\u0434\u0430\u043b\u0435\u043d\u043d\u043e\u0433\u043e \u0432\u043e\u0441\u043f\u0440\u043e\u0438\u0437\u0432\u0435\u0434\u0435\u043d\u0438\u044f."}))}a=Z7(this.o).o;var b=this.F;(a||b?a&&b&&a.trackName==b.trackName&&a.languageCode==b.languageCode&&a.languageName==b.languageName&&
a.kind==b.kind:1)||(this.F=a,Bya(this,a));a=Z7(this.o);-1==a.volume||Math.round(this.u.getVolume())==a.volume&&this.u.isMuted()==a.muted||this.R.isActive()||this.NC()}else Aya(this)};
...
O8.prototype.Ze=function(a){return"cast-selector-receiver"===a?"\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c":this.C[a].name};
