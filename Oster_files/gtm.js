...
"resource": {
  ...
  "macros":[{
      ...
      "vtp_fieldsToSet":["list",["map","fieldName","allowLinker","value","true"],["map","fieldName","cookieDomain","value","auto"],["map","fieldName","anonymizeIp","value","false"],["map","fieldName","siteSpeedSampleRate","value","100"]],
      "vtp_trackerName":"",
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(){return 0==",["escape",["macro",12],8,16],"?0:1})();"]
    },{
      "function":"__v",
      "vtp_dataLayerVersion":2,
      "vtp_setDefaultValue":false,
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(){var a=",["escape",["macro",15],8,16],";return a[0]})();"]
    },{
      "function":"__v",
      "vtp_dataLayerVersion":2,
      "vtp_setDefaultValue":false,
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(){return\"returning user\"==",["escape",["macro",17],8,16],"?0:1})();"]
    },{
      "function":"__v",
      "vtp_dataLayerVersion":2,
      "vtp_setDefaultValue":false,
      ...
      "function":"__c",
      "vtp_value":".btn-caja,.buy-button"
    },{
      "function":"__c",
      "vtp_value":"input.insert-sku-quantity"
    },{
      "function":"__c",
      "vtp_value":"UA-105607115-1"
    },{
  ...
  "tags":[{
      ...
      "vtp_conversionId":"742331192",
      "vtp_conversionLabel":"HfQ7CKzr7M4BELim_OEC",
      "vtp_rdp":false,
      "vtp_url":["macro",9],
      ...
      "vtp_uniqueTriggerId":"31180492_70",
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003Evar cbyDataImpression={init:function(){cbyDataImpression.validSearch()},validSearch:function(){0\u003C=$(\"body.search\").length\u0026\u0026cbyDataImpression.ajaxShelf()},ajaxShelf:function(){impressions=[];var a=1;$(\".shelf-search ul li:not(.helperComplement, .slick-slide),.vitrine ul li:not(.helperComplement, .slick-slide)\").livequery(function(){gtmProduct=$(this);id=gtmProduct.find(\".product-id, .idProduto\").text().trim();url=gtmProduct.find(\".product-more\").attr(\"href\");EscapedName=gtmProduct.find(\".product-name a, .product-title a\").text().trim();\nBestPrice=gtmProduct.find(\".newPrice .bestPrice, .newPrice .por\").text();CategoryName=gtmProduct.find(\".product-category\").text().trim();Brand=gtmProduct.find(\".brand\").text().trim();if(\"undefined\"!=typeof EscapedName\u0026\u0026\"\"!=EscapedName){var b={name:EscapedName,id:id,price:BestPrice,brand:Brand,category:CategoryName,position:a,list:window.location.pathname};a+=1;impressions.push(b)}});cbyDataImpression.dataLayerAdd(impressions)},dataLayerAdd:function(){window.dataLayer=window.dataLayer||[];window.dataLayer.push({event:\"cby.impression\",\necommerce:{currencyCode:",["escape",["macro",10],8,16],",impressions:impressions}})}};try{$(document).ready(function(){cbyDataImpression.init()})}catch(a){console.log(a)};\u003C\/script\u003E"],
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003Evar CheckoutSteps={init:function(){CheckoutSteps.sendData()},mountProducts:function(){products=[];var b=0;",["escape",["macro",11],8,16],".forEach(function(a){console.log(a,b);var c=a.name.split(\"-\");productName=c[0];products.push({name:productName,id:a.id,brand:a.brand,category:a.category,price:a.price,variant:a.skuName,quantity:a.quantity});b+=1});return products},sendData:function(){products=CheckoutSteps.mountProducts();dataLayer.push({event:\"checkout\",ecommerce:{checkout:{actionField:{step:4},products:products}},\nevent:\"cby.CheckoutStep\"})}};try{$(document).ready(function(){CheckoutSteps.init()})}catch(b){console.log(b)};\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":30
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003Etry{setTimeout(function(){dataLayer.push({info:{user:{isLoggedIn:",["escape",["macro",13],8,16],",clientId:",["escape",["macro",14],8,16],",clientEmail:",["escape",["macro",16],8,16],",isNewRegistration:",["escape",["macro",18],8,16],"},page:{pagePath:window.location.pathname,pageType:",["escape",["macro",19],8,16],",pageCategory:",["escape",["macro",20],8,16],",pageSubCategory:",["escape",["macro",21],8,16],"}},event:\"virtualPageview\"})},1E3)}catch(a){console.log(a)};\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":41
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003Evar cbyProductClickRemove={init:function(){cbyProductClickRemove.clickRemove()},clickRemove:function(){$(\"body\").on(\"click\",\".item-link-remove\",function(){var a=$(this).parents(\".product-item\"),b=a.attr(\"sku\"),c=a.find(\".product-name a\").text();a=a.find(\".quantity input\").val();window.dataLayer=window.dataLayer||[];window.dataLayer.push({event:\"cby.removeFromCart\",ecommerce:{currencyCode:",["escape",["macro",10],8,16],",remove:{products:[{name:c,id:b,quantity:a}]}}})})}};try{$(document).ready(function(){cbyProductClickRemove.init()})}catch(a){console.log(a)};\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":59
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003Evar cbyProductView={init:function(){cbyProductView.loadProductV()},loadProductV:function(){var a=",["escape",["macro",22],8,16],",b=",["escape",["macro",23],8,16],",c=",["escape",["macro",24],8,16],",d=",["escape",["macro",25],8,16],",e=",["escape",["macro",26],8,16],";window.dataLayer=window.dataLayer||[];window.dataLayer.push({ecommerce:{detail:{products:[{name:b,id:a,price:c,brand:d,category:e}]}},event:\"cby.ProductDetail\"})}};try{$(document).ready(function(){cbyProductView.init()})}catch(a){console.log(a)};\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":89
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003Evar CheckoutSteps={init:function(){CheckoutSteps.sendData()},mountProducts:function(){products=[];var b=0;",["escape",["macro",27],8,16],".forEach(function(a){console.log(a,b);var c=a.name.split(\"-\");productName=c[0];products.push({name:productName,id:a.id,brand:a.brand,category:a.category,price:a.price,variant:a.skuName,quantity:a.quantity});b+=1});return products},sendData:function(){products=CheckoutSteps.mountProducts();dataLayer.push({ecommerce:{currencyCode:",["escape",["macro",10],8,16],",purchase:{actionField:{id:",["escape",["macro",28],8,16],",\nrevenue:",["escape",["macro",29],8,16],",tax:\"0\",shipping:",["escape",["macro",30],8,16],",coupon:",["escape",["macro",31],8,16],"},products:products}},event:\"cby.purchase\"})}};try{$(document).ready(function(){CheckoutSteps.init()})}catch(b){console.log(b)};\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":92
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":["template","\u003Cscript type=\"text\/gtmscript\"\u003Evar cbyProductClick={init:function(){cbyProductClick.clickProduct()},clickProduct:function(){$(",["escape",["macro",32],8,16],").livequery(\"click\",function(){var Vid=",["escape",["macro",22],8,16],";var Vname=",["escape",["macro",23],8,16],";var VpriceTo=",["escape",["macro",24],8,16],";var Vbrand=",["escape",["macro",25],8,16],";var Vcategory=",["escape",["macro",26],8,16],";var Vid=",["escape",["macro",22],8,16],";var quantity_antiguo=$(",["escape",["macro",33],8,16],").val();var quantity=1;window.dataLayer=window.dataLayer||[];window.dataLayer.push({\"event\":\"cby.AddToCart\",\"ecommerce\":{\"currencyCode\":",["escape",["macro",10],8,16],",\n\"add\":{\"products\":[{\"name\":Vname,\"id\":Vid,\"price\":VpriceTo,\"brand\":Vbrand,\"category\":Vcategory,\"quantity\":quantity}]}}})})}};try{$(document).ready(function(){cbyProductClick.init()})}catch(err){console.log(err)};\u003C\/script\u003E"],
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":96
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\n\u003Cscript type=\"text\/gtmscript\"\u003E!function(b,e,f,g,a,c,d){b.fbq||(a=b.fbq=function(){a.callMethod?a.callMethod.apply(a,arguments):a.queue.push(arguments)},b._fbq||(b._fbq=a),a.push=a,a.loaded=!0,a.version=\"2.0\",a.queue=[],c=e.createElement(f),c.async=!0,c.src=g,d=e.getElementsByTagName(f)[0],d.parentNode.insertBefore(c,d))}(window,document,\"script\",\"https:\/\/connect.facebook.net\/en_US\/fbevents.js\");fbq(\"init\",\"2532382213757454\");fbq(\"track\",\"PageView\");\u003C\/script\u003E\n\u003Cnoscript\u003E\u003Cimg height=\"1\" width=\"1\" style=\"display:none\" src=\"https:\/\/www.facebook.com\/tr?id=2532382213757454\u0026amp;ev=PageView\u0026amp;noscript=1\"\u003E\u003C\/noscript\u003E\n",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":103
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\n\u003Cscript async data-gtmsrc=\"https:\/\/www.googletagmanager.com\/gtag\/js?id=AW-662913402\" type=\"text\/gtmscript\"\u003E\u003C\/script\u003E\n\u003Cscript type=\"text\/gtmscript\"\u003Ewindow.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments)}gtag(\"js\",new Date);gtag(\"config\",\"AW-662913402\");\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":106
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\"\u003E!function(b,e,f,g,a,c,d){b.fbq||(a=b.fbq=function(){a.callMethod?a.callMethod.apply(a,arguments):a.queue.push(arguments)},b._fbq||(b._fbq=a),a.push=a,a.loaded=!0,a.version=\"2.0\",a.queue=[],c=e.createElement(f),c.async=!0,c.src=g,d=e.getElementsByTagName(f)[0],d.parentNode.insertBefore(c,d))}(window,document,\"script\",\"https:\/\/connect.facebook.net\/en_US\/fbevents.js\");fbq(\"init\",\"194130048354235\");fbq(\"track\",\"PageView\");\u003C\/script\u003E\n\u003Cnoscript\u003E\u003Cimg height=\"1\" width=\"1\" style=\"display:none\" src=\"https:\/\/www.facebook.com\/tr?id=194130048354235\u0026amp;ev=PageView\u0026amp;noscript=1\"\u003E\u003C\/noscript\u003E\n",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":107
  ...
  "predicates":[{
      "function":"_eq",
      "arg0":["macro",0],
      "arg1":"cby.ProductDetail"
    },{
      "function":"_eq",
      "arg0":["macro",0],
      "arg1":"cby.CheckoutStep"
    },{
      "function":"_eq",
      "arg0":["macro",0],
      "arg1":"cby.purchase"
  ...
  "rules":[
    ...
    [["if",6],["add",5]],
    [["if",7],["add",6]],
    [["if",8],["add",8,9,13,15,17,23,24,26,27,12]],
    [["if",8,9],["add",10,25]],
    [["if",10],["add",11]],
    [["if",12],["add",14]],
    [["if",13],["add",16]],
...
return null},Wc=!1;if(F.querySelectorAll)try{var Xc=F.querySelectorAll(":root");Xc&&1==Xc.length&&Xc[0]==F.documentElement&&(Wc=!0)}catch(a){}var Tc=Wc;var kd={},ld=null,md=Math.random();kd.s="GTM-K5HL2CJ";kd.Ob="5e1";kd.Md="";var nd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},od="www.googletagmanager.com/gtm.js";
